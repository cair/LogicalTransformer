...
1. Input: Document **d**, Bayesian embedding **v<sub>t</sub>** for each word **w<sub>t</sub>** in the vocabulary, Relevance threshold **r**
2. For each word **w<sub>t</sub>** in the document **d**:
