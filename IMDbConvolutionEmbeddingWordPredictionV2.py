...
for j in range(len(args.target_tokens)):
	...
	X_train_balanced = np.zeros((args.number_of_examples, args.window_size*2, 1, args.hypervector_size), dtype=np.uint32)
	...
	X_test_balanced = np.zeros((args.number_of_examples, args.window_size*2, 1, args.hypervector_size), dtype=np.uint32)
